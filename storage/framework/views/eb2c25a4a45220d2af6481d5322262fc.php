<div x-data="{ showEditModal: false }" @close-modal.window="showEditModal = false">
    <div class="card-header d-flex justify-content-between">
        <div class="header-title">
            <input type="search" class="form-control" wire:model.live="search" placeholder="<?php echo e(__('views.search')); ?>...">
        </div>
            ...
            <table id="basic-table" class="table table-striped mb-0">
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <!--[if BLOCK]><![endif]--><?php if(in_array($user->role->key, ['vendor'])): ?>
                            <tr>
                                <td>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="8" class="text-center"><?php echo e(__('views.no_users_found')); ?></td>
                        </tr>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </tbody>
            </table>
...
[$__name, $__params] = $__split('dashboards.stores.users.user-form', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2627134251-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('dashboards.stores.users.user-form', ['user' => $selectedUser]);
