    ...
    <div class="hidden-md-up text-xs-center mobile d-flex align-items-center justify-content-end">
        ...
        <div class="mobile_logo ml-auto mr-auto">
            <a href="http://demo.bestprestashoptheme.com/savemart/">
                <img class="logo-mobile img-fluid" src="<?php echo e(asset('uplods/admin/settings/' . $settings->logo)); ?>" width="50" alt="<?php echo e($settings->name); ?>">
            </a>
        </div>
...
<?php /**PATH C:\laragon\www\pi\resources\views/front/includes/header-mobile.blade.php ENDPATH**/ ?>