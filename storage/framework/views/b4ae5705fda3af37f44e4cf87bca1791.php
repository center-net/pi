        ...
        <div class="row d-flex align-items-center">
            <div id="_desktop_logo"
                ...
                <a href="#">
                    <img class="logo img-fluid"
                         src="<?php echo e(asset('uplods/admin/settings/' . $settings->logo)); ?>" width="30"
            ...
            <div class="col-lg-9 col-md-9 header-menu d-flex align-items-center justify-content-end">
                <div class="data-contact d-flex align-items-center">
                    <div class="title-icon"><?php echo e(__('site.support')); ?><i class="icon-support icon-address"></i></div>
                    <div class="content-data-contact">
                        <div class="support"><?php echo e(__('site.call_support')); ?> :</div>
                ...
                <div class="contentsticky_group d-flex justify-content-end">
                    <div class="header_link_myaccount">
                        <a class="login" href="#" rel="nofollow" title="<?php echo e(__('site.login_to_customer_account')); ?>"><i
                                class="header-icon-account"></i></a>
                    </div>
                    <div class="header_link_wishlist">
                        <a href="#" title="<?php echo e(__('site.my_wishlists')); ?>">
                    ...
                    <div id="_desktop_cart">
                        <div class="blockcart cart-preview active" data-refresh-url="">
                            <div class="header-cart">
                                <div class="cart-left">
                                    <a href="#" title="<?php echo e(__('site.cart')); ?>">
                                ...
                                <div class="cart-right d-flex flex-column align-self-end ml-13">
                                    <span class="title-cart"><?php echo e(__('site.cart')); ?></span>
                                    <span class="cart-item"> <?php echo e(__('site.items')); ?></span>
                                </div>
                            </div>
...
<?php /**PATH C:\laragon\www\pi\resources\views/front/includes/header-center.blade.php ENDPATH**/ ?>