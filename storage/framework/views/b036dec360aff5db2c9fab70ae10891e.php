<div>
    <div class="card-header d-flex justify-content-between">
        <div class="header-title">
            <h4 class="card-title"><?php echo e(__('views.sub_categories')); ?></h4>
        </div>
    </div>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="<?php echo e(asset('images/shapes/01.png')); ?>" alt="profile">
...
<?php /**PATH C:\laragon\www\pi\resources\views/dashboards/subcategories/index.blade.php ENDPATH**/ ?>