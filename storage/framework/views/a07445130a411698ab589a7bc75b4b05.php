...
[$__name, $__params] = $__split('dashboards.stores.users.index');

$__html = app('livewire')->mount($__name, $__params, 'lw-3397305093-0', $__slots ?? [], get_defined_vars());
...
?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pi\resources\views/dashboards/stores/users/users.blade.php ENDPATH**/ ?>