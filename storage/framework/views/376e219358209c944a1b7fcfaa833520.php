...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="col-md-6 mb-3">
                <label class="form-label" for="role_id"><?php echo e(__('views.role')); ?></label>
                <select class="form-select" id="role_id" wire:model.defer="role_id">
                    <option value=""><?php echo e(__('views.select_role')); ?></option>
...
</div><?php /**PATH C:\laragon\www\pi\resources\views/dashboards/users/user-form.blade.php ENDPATH**/ ?>