...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="col-md-6 mb-3">
                <label class="form-label" for="email"><?php echo e(__('views.email')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="col-md-6 mb-3">
                <label class="form-label" for="mobile"><?php echo e(__('views.phone_number')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="col-md-6 mb-3">
                <label class="form-label" for="username"><?php echo e(__('views.username')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="col-md-6 mb-3">
                <label class="form-label" for="password"><?php echo e(__('views.password')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="col-md-6 mb-3">
                <label class="form-label" for="country_id"><?php echo e(__('views.country')); ?></label>
                <select class="form-select" id="country_id" wire:model.live="country_id">
                    <option value=""><?php echo e(__('views.select_country')); ?></option>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="col-md-6 mb-3">
                <label class="form-label" for="city_id"><?php echo e(__('views.city')); ?></label>
                <select class="form-select" id="city_id" wire:model.defer="city_id">
                    <option value=""><?php echo e(__('views.select_city')); ?></option>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="col-md-12 mb-3">
                <label class="form-label" for="address"><?php echo e(__('views.address')); ?></label>
...
</div><?php /**PATH C:\laragon\www\pi\resources\views/dashboards/stores/users/user-form.blade.php ENDPATH**/ ?>