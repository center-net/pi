        ...
        <div class="row d-flex align-items-center">
            <div class="contentsticky_verticalmenu verticalmenu-main col-lg-3 col-md-1 d-flex"
                ...
                <div class="toggle-nav d-flex align-items-center justify-content-start">
                    ...
                    <span><?php echo e(__('site.shop_by_categories')); ?></span>
                </div>
                            ...
                            <div id="megamenu" class="nov-megamenu clearfix">
                                <ul class="menu level1">
                                    <li class="item home-page has-sub"><span class="opener"></span><a
                                            href="index-3.htm?home" title="Home"><i
                                                class="zmdi zmdi-home"></i><?php echo e(__('site.home')); ?></a>
                                        <div class="dropdown-menu" style="width:200px">
                                            <ul class="">
                                                <li class="item "><a href="index-4.htm?home=home_1"
                                                        title="Homepage 1">Homepage
                                                        1</a></li>
                                                <li class="item "><a href="index-5.htm?home=home_2"
                                                        title="Homepage 2">Homepage
                                                        2</a></li>
                                                <li class="item "><a href="index.htm?home=home_3"
                                                        title="Homepage 3">Homepage
                                                        3</a></li>
                                                <li class="item "><a href="index-6.htm?home=home_4"
                                                        title="Homepage 4">Homepage
                                                        4</a></li>
                                                <li class="item "><a href="index-7.htm?home=home_5"
                                                        title="Homepage 5">Homepage
                                                        5</a></li>
                                                <li class="item "><a href="index-8.htm?home=home_6"
                                                        title="Homepage 6">Homepage
                                                        6</a></li>
                                                <li class="item "><a href="index-9.htm?home=home_7"
                                                        title="Homepage 7">Homepage
                                                        7</a></li>
                                                <li class="item "><a href="index-10.htm?home=home_8"
                                                        title="Homepage 8">Homepage
                                                        8</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                                            ...
                                                            <li class="item col-md-3 mw-20 html"><span
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul class="col">
                                                                        ...
                                                                        <li><a href="#">Category Left Sidebar</a>
                                                                        </li>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <ul class="">
                                                            ...
                                                            <li class="item col-lg-3 col-md-3 html"><span
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul class="col">
                                                                        <li><a href="#" title="Samsung ">Samsung
                                                                            </a>
                                                                        </li>
                                                                        ...
                                                                        <li><a href="#" title="Xiaomi ">Xiaomi
                                                                            </a></li>
                                                                        <li><a href="#" title="Huawei ">Huawei
                                                                            </a></li>
                                ...
                                <form method="get"
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="search_query_top"
                                            ...
                                            name="search_query" value="" placeholder="<?php echo e(__('site.search')); ?>">

                                        <div class="input-group-btn nov_category_tree hidden-sm-down">
                                            <button type="button" class="btn dropdown-toggle" data-toggle="dropdown"
                                                aria-haspopup="true" value="" aria-expanded="false">
                                                <?php echo e(__('site.categories')); ?>

                                            </button>
                                            <ul class="dropdown-menu list-unstyled">
                                                <li class="dropdown-item active" data-value="0">
                                                    <span><?php echo e(__('site.all_categories')); ?></span>
                                                </li>
                                                <li class="dropdown-item " data-value="2"><span><?php echo e(__('site.home')); ?></span></li>
...
<?php /**PATH C:\laragon\www\pi\resources\views/front/includes/header-bottom.blade.php ENDPATH**/ ?>