...
<head>
    ...
    <link rel="icon" type="image/vnd.microsoft.icon" href="{{ asset('uplods/admin/settings/' . $settings->icon) }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('uplods/admin/settings/' . $settings->icon) }}">
...
<div id="mobile-pagemenu" class="mobile-boxpage d-flex hidden-md-up">
    <div class="content-boxpage col">
        <div class="box-header d-flex justify-content-between align-items-center">
            <div class="title-box">{{ __('site.menu') }}</div>
            <div class="close-box">{{ __('site.close') }}</div>
        </div>
...
<div id="mobile-blockcart" class="mobile-boxpage d-flex hidden-md-up">
    <div class="content-boxpage col">
        <div class="box-header d-flex justify-content-between align-items-center">
            <div class="title-box">{{ __('site.cart') }}</div>
            <div class="close-box">{{ __('site.close') }}</div>
        </div>
...
<div id="mobile-pageaccount" class="mobile-boxpage d-flex hidden-md-up" data-titlebox-parent="Account">
    <div class="content-boxpage col">
        <div class="box-header d-flex justify-content-between align-items-center">
            <div class="back-box">{{ __('site.back') }}</div>
            <div class="title-box">{{ __('site.account') }}</div>
            <div class="close-box">{{ __('site.close') }}</div>
        </div>
        <div class="box-content d-flex justify-content-center align-items-center text-center">
            <div>
                    ...
                    <div class="account-list-content">
                        <div>
                            <a class="login" href="login-1.html" rel="nofollow" title="Log in to your customer account"><i
                                    class="fa fa-sign-in"></i>{{ __('site.sign_in') }}</a>
                        </div>
                        <div>
                            <a class="register" href="login-1.html" rel="nofollow" title="Register Account"><i
                                    class="fa fa-user"></i>{{ __('site.register_account') }}</a>
                        </div>
                        <div>
                            <a class="check-out" href="cart.html" rel="nofollow" title="Checkout"><i
                                    class="material-icons">check_circle</i>{{ __('site.checkout') }}</a>
                        </div>
                        <div class="link_wishlist">
                            <a href="login-2.html" title="My Wishlists">
                                <i class="fa fa-heart"></i>{{ __('site.my_wishlists') }}
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="links-language" data-target="#box-language" data-titlebox="Language"><span>{{ __('site.language') }}</span><i
                        class="zmdi zmdi-arrow-right"></i></div>
            </div>
        </div>
            ...
            <div class="w-100">
                ...
                <div class="item-language current">
                    <a rel="alternate" hreflang="{{ $localeCode }}"
                                               href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="d-flex align-items-center">
                    <img class="img-fluid mr-2"
                                            src="{{ asset('images/Flag/' . $properties['regional'] . '.png') }}"
                                            alt="{{ $properties['native'] }}"
                                            width="16" height="11"><span>{{ $properties['native'] }}</span></a>
                </div>
...
<div id="stickymenu_bottom_mobile" class="d-flex align-items-center justify-content-center hidden-md-up text-center">
    <div class="stickymenu-item"><a href="http://demo.bestprestashoptheme.com/savemart/"><i
                class="zmdi zmdi-home"></i><span>{{ __('site.home') }}</span></a></div>
    <div class="stickymenu-item"><a href="#" class="js-btn-search"><i
                class="zmdi zmdi-search"></i><span>{{ __('site.search') }}</span></a></div>
    <div class="stickymenu-item">
        <div id="_mobile_cart_bottom" class="nov-toggle-page" data-target="#mobile-blockcart"></div>
    </div>
    <div class="stickymenu-item"><a href="login-2.html"><i class="zmdi zmdi-favorite-outline"></i><span>{{ __('site.my_wishlists') }}</span></a>
    </div>
    <div class="stickymenu-item"><a href="#" class="nov-toggle-page" data-target="#mobile-pageaccount"><i
                class="zmdi zmdi-account-o"></i><span>{{ __('site.account') }}</span></a></div>
</div>
