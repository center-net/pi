<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
        <a href="{{ route('admin.dashboard') }}" class="navbar-brand">
            <img width="30" height="30" src="{{ asset('uploads/admin/settings/' . $settings->logo) }}" alt="">
                        ...
                        <div class="card shadow-none m-0">
                            <div class="card-header d-flex justify-content-between bg-primary py-3">
                                <div class="header-title">
                                    <h5 class="mb-0 text-white">{{ __('views.all_notifications') }}</h5>
                                </div>
                            </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="sub-drop dropdown-menu dropdown-menu-end p-0" aria-labelledby="mail-drop">
                        <div class="card shadow-none m-0">
                            <div class="card-header d-flex justify-content-between bg-primary py-3">
                                <div class="header-title">
                                    <h5 class="mb-0 text-white">{{ __('views.all_messages') }}</h5>
                                </div>
                            </div>
                            <div class="card-body p-0 ">
                                <a href="#" class="iq-sub-card">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown"
                        ...
                        <div class="caption ms-3 d-none d-md-block ">
                            <h6 class="mb-0 caption-title">{{ auth()->user()->name ?? __('views.visitor') }}</h6>
                            <p class="mb-0 caption-sub-title text-capitalize"></p>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="#">{{ __('views.profile') }}</a></li>
                        <li><a class="dropdown-item" href="#">{{ __('views.privacy_setting') }}</a></li>
                        <li>
